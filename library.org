...
- Interestingly, even as Rebecca Goldstein has acknowledged the split between rationalists adn empiricists at this time (late 17th century), she identified the curious geography of this split: rationalists tend to be from continental Europe, and empiricists tend to be from England.
...
- Evolution /per se/, and natural selection /per se/ weren't new during Darwin's (and Wallace's) time. Others, Charles Darwin's grandfather Erasmus, have already theorized those two concepts. The truly revolutionary concept that the two men came up with is that natural selection and evolution could be potent enough to explain every aspect of biological functions that would've been seen as "designed" by a deity.
