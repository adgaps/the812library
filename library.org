...
- For a few years, Taylor would be Liberia's dictator. In his time, Liberia would have a lucrative diamond trading industry, which Taylor uses for amassing personal wealth. The feat is all the more jarring because Liberia itself is not a diamond producer - it's all from nearby Sierra Leone, which Taylor also wants to rule for himself.
